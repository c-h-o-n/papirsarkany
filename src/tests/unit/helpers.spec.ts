...
test('normalizeOrderForm - set shipping information to undefined if "Személyes átvétel" is selected', () => {
...
test('normalizeOrderForm - returns the same object if "Postai szállítás" is selected', () => {
  const formData: OrderForm = {
    firstName: 'János',
    lastName: 'Kulka',
    email: 'janos.kulka@gmail.com',
