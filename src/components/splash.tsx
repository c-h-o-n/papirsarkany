...
export default async function Splash() {
  ...
  return (
    ...
    >
      <div className='home-pattern h-screen w-screen grid row-start-1 row-end-1 col-start-1 col-end-1' />
      <div className="space-y-8 px-2 text-center sm:px-4  row-start-1 row-end-1 col-start-1 col-end-1 z-10  ">
        <Link
